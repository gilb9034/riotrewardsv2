...
import riotrewards_icon from './Images/riotrewards_ico.png'
import riotrewards from './Images/riotrewards.png'
      ...
      <div className="Main_div">
        <div className="container">
              ...
              <div class="card  mt-4 mt-md-4">
                <div class="card-body text-center">
                  <div className="d-flex flex-column justify-content-center mt-4">
                    <h1 className=' fw-bolder'>Your Riot Balance</h1>
                  ...
                  <div className="d-flex flex-column justify-content-center mt-4">
                    <h1 className=' fw-bolder'>Total rewards</h1>
          ...
          <div className=" mt-5 logoMaindiv2 pb-2 d-flex justify-content-center align-items-center">
            ...
            <a href="https://t.me/RiotRewards"><i class="fab fs-3 marginLeft fa-telegram-plane"></i></a>
            <a href="https://twitter.com/riotrewardsbsc?s=21"><i class="fab fs-3 marginLeft fa-twitter"></i></a>
          </div>
        </div>
